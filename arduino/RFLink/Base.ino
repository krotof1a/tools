...
#define PIN_RF_TX_VCC               12                                          // +5 volt / Vcc power to the transmitter on this pin
#define PIN_RF_TX_DATA              13                                          // Data to the 433Mhz transmitter on this pin
#define PIN_RF_TX_GND               11
#define PIN_RF_RX_VCC               2                                          // Power to the receiver on this pin
#define PIN_RF_RX_DATA              4                                          // On this input, the 433Mhz-RF signal is received. LOW when no signal.
#define PIN_RF_RX_GND               5
//****************************************************************************************************************************************
...
void setup() {
  ...
  pinMode(PIN_RF_TX_GND,  OUTPUT);
  digitalWrite(PIN_RF_TX_GND,LOW);
  ...
  pinMode(PIN_RF_RX_GND,  OUTPUT);
  digitalWrite(PIN_RF_RX_GND,LOW);
