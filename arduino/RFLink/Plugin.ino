...
#ifdef PLUGIN_404
#include PLUGINFILE(SKETCH_PATH,Plugin_404.c)
#endif

#ifdef PLUGIN_405
#include PLUGINFILE(SKETCH_PATH,Plugin_405.c)
#endif
...
void PluginInit(void)
  ...
  #ifdef PLUGIN_404
  Plugin_id[x]=404;Plugin_ptr[x++]=&Plugin_404;
  #endif

  #ifdef PLUGIN_405
  Plugin_id[x]=405;Plugin_ptr[x++]=&Plugin_405;
  #endif
...
void PluginTXInit(void)
  ...
  #ifdef PLUGIN_TX_404
  PluginTX_id[x]=404;PluginTX_ptr[x++]=&PluginTX_404;
  #endif
  
  #ifdef PLUGIN_TX_405
  PluginTX_id[x]=405;PluginTX_ptr[x++]=&PluginTX_405;
  #endif
